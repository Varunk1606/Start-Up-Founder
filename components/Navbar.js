...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between items-center bg-blue-950 text-white h-25 md:h-16 px-10  flex-col md:flex-row'>
      <Link href={"/"} className='font-bold text-lg flex justify-center items-center gap-2'>
        <img width={30} src="/icons/logo.png" alt="" />
        <span>Start-Up Funder</span>
      </Link>
      ...
      <div className='relative flex justify-center items-center'>
        ...
        {session && <button onClick={() => signOut()} type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">LogOut</button>
        }
